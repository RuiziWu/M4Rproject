...
np.savetxt("KSD_value_10.csv", KSD_value, delimiter=",")
np.savetxt("KSD_variance_10.csv", KSD_variance, delimiter=",")
np.savetxt("KSD_prob_10.csv", KSD_prob, delimiter=",")
np.savetxt("KSD_cheb_10.csv", KSD_cheb, delimiter=",")
