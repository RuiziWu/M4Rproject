...
np.savetxt("KSD_value_70.csv", KSD_value, delimiter=",")
np.savetxt("KSD_variance_70.csv", KSD_variance, delimiter=",")
np.savetxt("KSD_prob_70.csv", KSD_prob, delimiter=",")
np.savetxt("KSD_cheb_70.csv", KSD_cheb, delimiter=",")
