...
np.savetxt("KSD_value_40.csv", KSD_value, delimiter=",")
np.savetxt("KSD_variance_40.csv", KSD_variance, delimiter=",")
np.savetxt("KSD_prob_40.csv", KSD_prob, delimiter=",")
np.savetxt("KSD_cheb_40.csv", KSD_cheb, delimiter=",")
