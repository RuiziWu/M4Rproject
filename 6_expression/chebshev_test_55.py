...
np.savetxt("KSD_value_55.csv", KSD_value, delimiter=",")
np.savetxt("KSD_variance_55.csv", KSD_variance, delimiter=",")
np.savetxt("KSD_prob_55.csv", KSD_prob, delimiter=",")
np.savetxt("KSD_cheb_55.csv", KSD_cheb, delimiter=",")
