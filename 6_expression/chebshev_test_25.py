...
np.savetxt("KSD_value_25.csv", KSD_value, delimiter=",")
np.savetxt("KSD_variance_25.csv", KSD_variance, delimiter=",")
np.savetxt("KSD_prob_25.csv", KSD_prob, delimiter=",")
np.savetxt("KSD_cheb_25.csv", KSD_cheb, delimiter=",")
