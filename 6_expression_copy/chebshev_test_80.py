...
alpha = 0.05
count = 6
dim_list = np.array([55, 60, 65, 70, 75, 80])
...
np.savetxt("KSD_value_80.csv", KSD_value, delimiter=",")
np.savetxt("KSD_variance_80.csv", KSD_variance, delimiter=",")
np.savetxt("KSD_prob_80.csv", KSD_prob, delimiter=",")
np.savetxt("KSD_cheb_80.csv", KSD_cheb, delimiter=",")
