...
alpha = 0.05
count = 6
dim_list = np.array([25, 30, 35, 40, 45, 50])
...
np.savetxt("KSD_value_50.csv", KSD_value, delimiter=",")
np.savetxt("KSD_variance_50.csv", KSD_variance, delimiter=",")
np.savetxt("KSD_prob_50.csv", KSD_prob, delimiter=",")
np.savetxt("KSD_cheb_50.csv", KSD_cheb, delimiter=",")
