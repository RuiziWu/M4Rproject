...
np.savetxt("KSD_value_20.csv", KSD_value, delimiter=",")
np.savetxt("KSD_variance_20.csv", KSD_variance, delimiter=",")
np.savetxt("KSD_prob_20.csv", KSD_prob, delimiter=",")
np.savetxt("KSD_cheb_20.csv", KSD_cheb, delimiter=",")
