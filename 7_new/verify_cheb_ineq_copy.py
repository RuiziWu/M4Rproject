...
# count = len(dim_list)
count = 10
dim_list = np.array([i*3 for i in range(count)])
dim_list[0] = 1
...
np.savetxt("True_expectation_test20.csv", True_ksd, delimiter=",")
np.savetxt("True_variance_test20.csv", True_variance, delimiter=",")
np.savetxt("P_ksd_test20.csv", P_ksd_alpha, delimiter=",")
np.savetxt("KSD_whole_test20.csv", KSD_whole, delimiter=",")